...
resource "azurerm_subnet" "subnet" {
  ...
  depends_on = [azurerm_resource_group.this, azurerm_virtual_network.vnet]
}
...
resource "azurerm_network_interface" "this" {
  ...
  tags = var.tags
  depends_on = [azurerm_resource_group.this, azurerm_subnet.subnet]
}

resource "azurerm_virtual_network" "vnet" {
  name                = "vnet-demo"
  location            = "northeurope"
  resource_group_name = "windowvmdemo"
